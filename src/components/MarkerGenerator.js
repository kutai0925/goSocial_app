...
const UserOffscreenMarker = ({ user, onCapture }) => {
  ...
  return (
    ...
    >
      <View style={{ width: size, height: size, borderRadius: size / 2, borderWidth: 3, borderColor: "#FFFFFF", backgroundColor: cleanUrl ? '#FFFFFF' : "#8B4CC2", overflow: 'hidden', alignItems: "center", justifyContent: "center" }}>
        {cleanUrl ? (
          <Image 
            source={{ uri: cleanUrl }} 
